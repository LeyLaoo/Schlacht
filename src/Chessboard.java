...
public class Chessboard {
    ...
    /**
     * Is true when the chess piece belongs to player 1 (white)
     * @param x x-position of the piece
     * @param y y-position of the piece
     * @return returns true when the piece belongs to player 1, otherwise false
     */
    public boolean isPlayerOne(int x, int y){
        if(board[x][y] == null || board[x][y] instanceof Closed) throw new IllegalStateException("not a player");
        return board[x][y].isPlayerOne();
    }

    /**
     * returns the type of the piece as String
     * @param x x-position of the piece
     * @param y y-position of the piece
     * @return returns the type of the pawn as String
     */
